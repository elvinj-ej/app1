...
def api_receiving_send_email(month):
    try:
        ...
        html_body = (
            ...
            "<td>"
            "<p style=\"margin:0 0 8px 0;color:#F0C040;font-size:11px;font-weight:bold;letter-spacing:2px;text-transform:uppercase;font-family:Arial,Helvetica,sans-serif\">AWS FinOps &nbsp;&middot;&nbsp; Marketplace &nbsp;&middot;&nbsp; Monthly Cost Report</p>"
            "<p style=\"margin:0 0 6px 0;color:#ffffff;font-size:34px;font-weight:bold;line-height:1.1;font-family:Arial,Helvetica,sans-serif\">Marketplace Receiving Summary</p>"
